...
#ifdef __linux__
    STATIC_REQUIRE(TypeSizes::sizeOfLdivT == 16);
#else
...
#ifdef __linux__
    STATIC_REQUIRE(TypeSizes::sizeOfLong == 8);
    STATIC_REQUIRE(TypeSizes::sizeOfLongDouble == 16);
    STATIC_REQUIRE(TypeSizes::sizeOfLongInt == 8);
#else
...
#ifdef __linux__
    STATIC_REQUIRE(TypeSizes::sizeOfULong == 8);
    STATIC_REQUIRE(TypeSizes::sizeOfULongInt == 8);
#else
...
#ifdef __linux__
    STATIC_REQUIRE(TypeSizes::sizeOfString == 32);
    STATIC_REQUIRE(TypeSizes::sizeOfWString == 32);
    STATIC_REQUIRE(TypeSizes::sizeOfU8String == 32);
    STATIC_REQUIRE(TypeSizes::sizeOfU16String == 32);
    STATIC_REQUIRE(TypeSizes::sizeOfU32String == 32);
#else
